...
class SalidaTerreno(models.Model):
    ...
    diasemana = models.ForeignKey(DiaSemana, on_delete=models.CASCADE,blank=True, null=True)
    ...
    num_salida = models.IntegerField(validators=[MaxValueValidator(999)])
    asig_comp_terreno = models.ForeignKey(Asignatura, on_delete=models.CASCADE, related_name='salidas_terreno_asig_comp_terreno', blank=True, null=True)
    observaciones = models.TextField()
